...
class TestUploadDocumentsToVectorstore:
    ...
    def test_upload_documents_basic(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
        ...
        docs = [
            Document(
                page_content="Content 1", metadata={"source": "test1.txt"}
            ),
            Document(
                page_content="Content 2", metadata={"source": "test2.txt"}
            ),
        ]
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_documents_with_custom_index(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
        ...
        assert (
            mock_chroma_class.call_args[1]["collection_name"] == "custom-index"
        )

    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_documents_with_metadata(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_documents_without_metadata(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_documents_with_persist_method(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_documents_with_client_persist(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_empty_documents_list(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
...
class TestGetFullDocumentContent:
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_get_full_document_content_local_success(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_get_full_document_content_local_not_found(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_get_full_document_content_local_sorts_chunks(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_get_full_document_content_local_missing_metadata(
        self, mock_embeddings_class, mock_chroma_class
    ):
...
class TestDebugListDocumentSources:
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_list_document_sources_local_success(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_list_document_sources_local_empty(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_list_document_sources_local_with_unknown(
        self, mock_embeddings_class, mock_chroma_class
    ):

        mock_collection = MagicMock()
        mock_collection.get.return_value = {
            "metadatas": [{"source": "doc1.pdf"}, {}, {"other_field": "value"}]
        }
...
class TestDebugGetLocalContentForSource:
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_debug_get_local_content_success(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_debug_get_local_content_no_matches(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_debug_get_local_content_long_preview(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_debug_get_local_content_with_metadata(
        self, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_debug_get_local_content_exception(
        self, mock_embeddings_class, mock_chroma_class
    ):
...
class TestEnvironmentConfiguration:
    ...
    def test_environment_variables_loaded(self):
        ...
        assert (
            loader.vector_store.OLLAMA_BASE_URL == "http://test-ollama:11434"
        )
...
class TestIntegration:
    ...
    @patch("loader.vector_store.OllamaEmbeddings")
    @patch("loader.vector_store.os.makedirs")
    def test_upload_and_retrieve_workflow(
        self, mock_makedirs, mock_embeddings_class, mock_chroma_class
    ):
    ...
    @patch("loader.vector_store.Chroma")
    @patch("loader.vector_store.OllamaEmbeddings")
    def test_list_and_debug_workflow(
        self, mock_embeddings_class, mock_chroma_class
    ):
