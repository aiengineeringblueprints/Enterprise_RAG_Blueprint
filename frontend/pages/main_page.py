...
st.write("# Welcome to optimAIse")
st.write(
    "optimAIse is an app that can automate your organizations. "
...
st.write("Try it out, it will be like magic!")
